                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="POST" action="{{ route($profileData->role . '.update.password') }}" enctype="multipart/form-data">

                                @csrf

                                <div class="form-floating mb-3">
                                    <input type="password" name="old_password" class="form-control @error('old_password') is-invalid @enderror" id="old_password">
                                    <label class="form-label"><i class="ti ti-user me-2 fs-4"></i>Old Password</label>
                                    @error('old_password')
