...
<header class="app-header">
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="d-block d-lg-none">
            <img src="{{ asset('dark-logo.png') }}" class="dark-logo" width="180" alt="" />
            <img src="{{ asset('light-logo.png') }}" class="light-logo" width="180" alt="" />
        </div>
                ...
                <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                    ...
                    <li class="nav-item">
                        <a href="javascript:void(0)" onclick="toggleTheme('../../dist/css/style.min.css')"
                            class="rounded-2 p-3 customizer-box hover-img d-flex align-items-center light-theme text-dark">
                            <i class="ti ti-brightness-up fs-7 text-primary"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="javascript:void(0)" onclick="toggleTheme('../../dist/css/style-dark.min.css')"
                            class="rounded-2 p-3 customizer-box hover-img d-flex align-items-center dark-theme text-dark">
                        ...
                        <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                            ...
                            <div class="profile-dropdown position-relative" data-simplebar>
                                ...
                                <div class="message-body">
                                    <a href="{{ route('class_adviser.profile') }}" class="py-8 px-7 mt-8 d-flex align-items-center">
                                        <span
                                ...
                                <div class="d-grid py-4 px-7 pt-8">
                                    <a href="{{ route('class_adviser.logout') }}" class="btn btn-outline-primary">Log Out</a>
                                </div>
                            </div>
                        </div>
                    </li>
